 ...
 */
require_once 'lib/library/Zend/Gdata/YouTube/MediaEntry.php';

/**
 * @see Zend_Gdata_YouTube_Extension_MediaGroup
 */
require_once 'lib/library/Zend/Gdata/YouTube/Extension/MediaGroup.php';

/**
 * @see Zend_Gdata_YouTube_Extension_NoEmbed
 */
require_once 'lib/library/Zend/Gdata/YouTube/Extension/NoEmbed.php';
 ...
 */
require_once 'lib/library/Zend/Gdata/YouTube/Extension/Link.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Racy
 */
require_once 'lib/library/Zend/Gdata/YouTube/Extension/Racy.php';
 ...
 */
require_once 'lib/library/Zend/Gdata/YouTube/Extension/Control.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Recorded
 */
require_once 'lib/library/Zend/Gdata/YouTube/Extension/Recorded.php';
...
class Zend_Gdata_YouTube_VideoEntry extends Zend_Gdata_YouTube_MediaEntry
{
    ...
    public function setVideoRating($ratingValue)
    {
        if ($ratingValue < 1 || $ratingValue > 5) {
            require_once 'lib/library/Zend/Gdata/App/InvalidArgumentException.php';
