 ...
 * Zend_Gdata_Feed
 */
require_once 'lib/library/Zend/Gdata/App/Feed.php';

/**
 * Zend_Gdata_Http_Client
 */
require_once 'lib/library/Zend/Http/Client.php';
 ...
 */
require_once 'lib/library/Zend/Gdata/App/MediaSource.php';

/**
 * Zend_Uri/Http
 */
require_once 'lib/library/Zend/Uri/Http.php';
...
class Zend_Gdata_App
{
    ...
    {
        require_once 'lib/library/Zend/Http/Client/Exception.php';
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once 'lib/library/Zend/Gdata/HttpAdapterStreamingProxy.php';
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once 'lib/library/Zend/Gdata/HttpAdapterStreamingSocket.php';
